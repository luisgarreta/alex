---
title: "Análisis predictivo de desistimiento en desmovilizados"
output:
  html_document:
    toc: yes
    number_sections: yes
...
-   Primero, desde Rstudio instalar el paquete "devtools" para manejar la instalación con todas las dependencias de forma automática.

-   Segundo, ejecutar la función "install_github" con el nombre del repositorio del paquete "desistimiento.
